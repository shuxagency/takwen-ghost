...
export const lang: KeyObjectMap = {
  ...
  ar: {
    A_COLLECTION_OF: `A collection of`,
    BY: `by`,
    BY_THIS_AUTHOR: `بواسطة`,
    GOTO_FRONT_PAGE: `الذهاب للرئيسية`,
    LATEST_POSTS: `اخر الدراسات`,
    IS_REQUIRED: `مطلوب`,
    MIN_READ: `دقيقة للقرائة`,
    MORE_IN: `المزيد في`,
    MORE_POSTS: `المزيد`,
    MORE_POSTS_SM: `المزيد`,
    NEXT: `التالي`,
    NO_POSTS: `لا يوجد دراسات`,
    ...
    READ: `قراءة`,
    SEE_ALL: `عرض الكل`,
    SUBSCRIBED_TO: `لقد اشتركت بنجاح لـ`,
    WEBSITE: `Website`,
    MULTIPLE_AUTHORS: `عدة كاتبين`,
    DARK_MODE: `الوضع الداكن`,
    CHECK_YOUR_INBOX: `تحقق من صندوق الوارد واضغط الرابط المرسل لك لتاكيد الاشتراك`,
    EMAIL: `البريد الالكتروني`,
    ENTER_VALID_EMAIL: `يرجى ادخال بريد الكتروني صالح`,
    GREAT: `رائع`,
    SUBSCRIBE: `اشتراك`,
    SUBSCRIBE_OVERLAY: `اشترك في النشرة البريدية وكن على اطلاع مستمر باحدث المستجدات حول دراسات الحالة المقدمة من تكوين`,
    SUBSCRIBE_SECTION: `احصل على احدث دراسات الحالة مباشرة على بريدك الالكتروني`,
    SUBSCRIBE_TO: `الاشتراك لـ`,
    SUBSCRIBED_FAILED: `خطا في رابط التسجيل، لم نتمكن من اتمام عملية التسجيل!`,
    YOUR_EMAIL: `youremail@example.com`,
    AT_LEAST: `على الأقل`,
    CHARACTERS_LONG: `طول عدد الاحرف`,
    CHARACTERS_OR_LESS: `حرف او اقل`,
    EMAIL_ADDRESS: `البريد الالكتروني`,
    EMAIL_IS_REQUIRED: `البريد الالكتروني مطلوب`,
    FULL_NAME: `الاسم الكامل`,
    FULL_NAME_REQUIRED: `الاسم الكامل مطلوب`,
    FULL_NAME_MUST_BE: `الاسم الكامل يجب امن يكون`,
    INVALID_EMAIL_ADDRESS: `عنوان بريد الكتروني فير صالح`,
    MESSAGE_MUST_BE: `رسالتك يجب ان تكون`,
    MESSAGE_SENT: `شكراً لك، تم ارسال رسالتك بنجاح.`,
    MESSAGE_TEXT_IS_REQUIRED: `نص الرسال مطلوب.`,
    ONE_SECOND: `لحظة واحدة من فضلك....`,
    SENDING_FAILED: `اوه *_*, فشل الارسال هذا محرج`,
    PLEASE_SELECT: `يرجى الاختيار`,
    PLEASE_SELECT_SUBJECT: `يرجى اختيار موضوع واحد`,
    SUBMIT: `ارسال`,
    YOUR_MESSAGE: `رسالتك`,
    TABLE_OF_CONTENTS: `جدول المحتوى`,
  },
  ptBR: {
